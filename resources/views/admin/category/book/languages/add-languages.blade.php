...
<main id="tg-main" class="tg-main tg-haslayout">
			...
			<section class="tg-dbsectionspace tg-haslayout">
				<div class="row">
					<form class="tg-formtheme tg-formdashboard" method="post" action="{{ route('insert-book-languages') }}">
						 {{ csrf_field() }}
						<fieldset>
...
<!--                                            Book Category ID-->
											...
											<div class="form-group">
												<input type="text" name="book_language_name" class="form-control" placeholder="book_language_name">
											</div>
