...
$(document).ready(function(){
 ...
 {
  $('#id').html('');
  $('#post_language_icon').html('');
 }

 function language_fetch_data(page, sort_type, sort_by, query)
 {
  $.ajax({
   url:"/language/pagination/language_fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
 ...
 $(document).on('keyup', '#serach', function(){
  ...
  language_fetch_data(page, sort_type, column_name, query);
 });

 $(document).on('click', '.sorting', function(){
  var column_name = $(this).lng('column_name');
  var order_type = $(this).lng('sorting_type');
  var reverse_order = '';
  if(order_type == 'asc')
  {
   $(this).lng('sorting_type', 'desc');
   reverse_order = 'desc';
   clear_icon();
  ...
  var page = $('#hidden_page').val();
  var query = $('#serach').val();
  language_fetch_data(page, reverse_order, column_name, query);
 });
