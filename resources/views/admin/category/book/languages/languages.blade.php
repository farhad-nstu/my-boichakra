@extends('admin.category.book.languages.master')
...
<button class="btn btn-success" style="margin-left: 900px; margin-top: 10px;"><a href="{{ route('add-book-languages') }}" style="color: white;">Add Languages</a></button>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="tg-dashboardbox">
                  ...
                  <table class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th class="sorting" data-sorting_type="asc" data-column_name="id" style="cursor: pointer">ID <span id="id"></span></th>
                        <th class="sorting" data-sorting_type="asc" data-column_name="book_language_name" style="cursor: pointer">Title <span id="post_language_icon"></span></th>
                        <th>Ad Status</th>
                        <th>Action</th>
                      </tr>
                    </thead>
                    <tbody>
                    @include('admin.category.book.languages.pagination_data')
                    </tbody>
                  </table>
