@extends('admin.category.book.tags.master')
...
<button class="btn btn-info" style="margin-left: 900px; margin-top: 10px;"><a href="{{ route('add-book-tags') }}" style="color: white;">Add Tags</a></button>
                  ...
                  <div class="tg-dashboardholder">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="sorting" data-sorting_type="asc" data-column_name="book_tag_name" style="cursor: pointer">Title <span id="post_tag_icon"></span></th>
                        <th>Ad Status</th>
                        <th>Action</th>
                      </tr>
                    </thead>
                    <tbody>
                    @include('admin.category.book.tags.pagination_data')
                    </tbody>
                  </table>
