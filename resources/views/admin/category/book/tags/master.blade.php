...
$(document).ready(function(){
 ...
 function tag_fetch_data(page, sort_type, sort_by, query)
 {
  $.ajax({
   url:"/tag/pagination/tag_fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
 ...
 $(document).on('keyup', '#serach', function(){
  ...
  tag_fetch_data(page, sort_type, column_name, query);
 });

 $(document).on('click', '.sorting', function(){
  var column_name = $(this).tag('column_name');
  var order_type = $(this).tag('sorting_type');
  var reverse_order = '';
  if(order_type == 'asc')
  {
   $(this).tag('sorting_type', 'desc');
   reverse_order = 'desc';
   clear_icon();
  ...
  var page = $('#hidden_page').val();
  var query = $('#serach').val();
  tag_fetch_data(page, reverse_order, column_name, query);
 });
