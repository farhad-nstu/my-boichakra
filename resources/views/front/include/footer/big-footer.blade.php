					...
					<div class="tg-footerinfo">
						...
						<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
							<div class="tg-widget tg-widgettext">
								<div class="tg-widgetcontent">
									<strong class="tg-logo"><a href="javascript:void(0);"><img src="{{asset('/')}}front/images/logof.png" alt="image description"></a></strong>
									...
									<span class="tg-copyright">2019 All Rights Reserved &copy; Solution PRO</span>
								</div>
							</div>
						</div>
					</div>
